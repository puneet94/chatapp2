...
export default class GroupChatBoxComponent extends React.Component {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          {message.type==='img'?<Image style={{height: 80,width:80}} source={{
							uri: chat.message
						}}></Image>:<RkText rkType='primary3 mediumLine chat'>{message.message}</RkText>}
